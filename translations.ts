export const translations = {
  en: {
    ...
    analytics_social_download_desc: 'The social network graph can become complex. For a better experience with large networks, please download the interactive map.',
  ...
  de: {
    ...
    'log_action_found_culture_fail_member': '{agentName} kann keine neue Kultur gründen, während er bereits Teil einer ist.',
    ...
    'log_action_recruit_culture_no_target': '{agentName} suchte jemanden zum Rekrutieren, fand aber niemanden in der Nähe.',
    'log_action_recruit_culture_no_culture': '{agentName} kann nicht für eine Kultur rekrutieren, der er nicht angehört.',
    log_action_propose_law_approved: "Die {cultureName}-Kultur hat das neue Gesetz '{lawName}' genehmigt. Es tritt nun in Kraft.",
    ...
    analytics_social_download_desc: 'Das soziale Netzwerk kann komplex werden. Für eine bessere Darstellung bei großen Netzwerken, laden Sie bitte die interaktive Karte herunter.',
    ...
    log_guard_warning: "🛡️ Wache {guardName} hat {criminalName} ermahnt, das {crime} zu unterlassen.",
