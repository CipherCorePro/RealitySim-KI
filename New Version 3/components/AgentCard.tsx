...
export const AgentCard: React.FC<AgentCardProps> = ({ agent, allAgents, cultures, religions, onPrompt, onGeneratePsychoanalysis }) => {
        ...
        <div className={`bg-slate-850 p-4 rounded-lg border border-slate-700 space-y-4 relative ${!agent.isAlive ? 'saturate-50' : ''}`}>
            ...
            <div className="flex items-start justify-between">
                ...
                <button
                    ...
                    className="bg-slate-700 hover:bg-slate-600 text-slate-200 font-bold p-2.5 rounded-md transition-colors disabled:opacity-50"
                    aria-label={t('psychoanalysis_generate_button')}
