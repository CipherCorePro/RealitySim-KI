...
export const translations = {
  ...
  de: {
    ...
    psychoanalysis_generate_button: 'Psychologisches Profil anzeigen',
    psychoanalysis_generating: 'Profil wird generiert...',
    ...
    log_action_mentor_success: '🎓 {mentorName} hat {studentName} erfolgreich in der Fähigkeit {skill} unterrichtet.',
    log_action_mentor_fail_skill: '{agentName} wollte jemanden unterrichten, hat aber nicht genügend Expertise.',
    log_action_mentor_no_one: '{agentName} suchte einen jungen Agenten zum Unterrichten, fand aber niemanden.',
    ...
    goal_mentorYoungAgent: 'Einen jungen Agenten unterrichten',
